...
download.file(
	url = "https://ftp.ncbi.nlm.nih.gov/geo/series/GSE131nnn/GSE131461/suppl/GSE131461_beta_matrix.txt.gz", 
...
covariates$group = as.character(covariates$"characteristics_ch1.2")
...
estimateSD = function(Y,meta){
  return( summary(lm(Y~age+gender+group,data=meta))$sigma )
}
