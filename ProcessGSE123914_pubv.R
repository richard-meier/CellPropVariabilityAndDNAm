...
load("...targetDirectory/Objects for Deconvolution V2.RData")
source("...targetDirectory/Deconvolution code.R")
...
covariates$year = covariates$"year of collection:ch1"
# I decided to model this one as a categorical variable
table(covariates$year)
...
estimateSD = function(Y,meta){
	return( summary(lm(Y~age+year,data=meta))$sigma )
}
